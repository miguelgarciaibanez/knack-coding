...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/Loader</a> FileLoader.js</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  _requireClassNameFromPath (classObject, mainClassName) {
    let fromDirectory = (!path.isAbsolute(classObject)) ? path.dirname(this.filePath) : <span class="branch-1 cbranch-no" title="branch not covered" >'/'</span>
...
&nbsp;
    ...
    return mainClass || defaultClass || fileNameClass || <span class="branch-3 cbranch-no" title="branch not covered" >exportedModule</span>
  }
}
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Aug 10 2021 12:08:40 GMT+0200 (Central European Summer Time)
            </div>
        </div>
